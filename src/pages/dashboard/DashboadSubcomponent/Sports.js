...
const Sports = () => {
  return (
    <Box>
      <Box sx={style.root}>
        <Box sx={style.roottwo} component={NavLink} to={"/cricket/user-profile"}>
          ...
          <Box sx={{ width: "30%", height: "100%" }}>
            <Box component="img" sx={style.imgtwo} src={'https://static.vecteezy.com/system/resources/previews/001/988/262/original/cricket-match-concept-with-stadium-and-background-free-vector.jpg'}></Box>
          </Box>
        </Box>
      </Box>
    </Box>

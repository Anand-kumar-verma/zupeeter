...
import { Box, Button, Container, IconButton, InputAdornment, OutlinedInput, Stack, Typography } from '@mui/material';
  ...
  return (
    <Layout footer={false}>
      <Container className='no-scrollbar' sx={{ background: zubgback, width: '100%', height: '100vh', overflow: 'auto' }}>
        ...
        <Box>
          <Box sx={{ padding: '10px', width: '95%', margin: 'auto', mt: 2, background: zubgback_cricket, borderRadius: '10px', mb: 2 }}>
